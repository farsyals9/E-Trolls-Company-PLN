			...
			<?php if(isset($_GET['excel'])){ ?>
				...
				<?php }else{ ?>
					<td style="margin-top: -20px;" width="15%" valign="top">
						<img src="../images/logo_e-trolls.png" width="90px" height="90px">
					</td>
				<?php } ?>
			<td colspan="10" align="left">
				<h4 style="margin-top: 10px;margin-left: -10px;">PERUSAHAAN PEMBAYARAN LISTRIK</h4>
				<h1 style="margin-top: -20px;margin-left: -10px;" >E-TROLLS COMPANY</h1>
				<h5 style="margin-top: -20px;margin-left: -10px;">Jl. Jend. Sudirman kav 52-53 No.Kav 52-53, RT.5/RW.3, Senayan, Kebayoran Baru, South Jakarta City, Jakarta 12190</h5>
			</td>
		</tr>
